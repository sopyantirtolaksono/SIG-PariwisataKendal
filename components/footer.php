            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-4 ">
                    <div class="footer_widget">
                        ...
                        <p>Jl. Soekarno Hatta No. 124 Kendal, Kabupaten Kendal. Kode Pos 51351 <br>
                            <a href="tel:+62294384464">(0294)384464</a> <br>
                            <a href="mailto:dolanoservice@dolano.web.id">dolanoservice@dolano.web.id</a>
                        </p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Pariwisata Kendal <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="http://www.dolano.web.id" target="_blank">Dolano</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </p>
                </div>
            </div>
